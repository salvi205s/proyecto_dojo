    ...
    <div class="container-xl m-auto">
        ...
        <div id="contenedor" class="cuerpo m-auto p-0 d-flex align-items-stretch">
            ...
            <div class="centro col-md-8 mb-4">
                ...
                <!-- contacto -->
                <div class="contacto col-12 p-3 text-center font-weight-bold pb-5 ">



                    <div class="col-12 m-auto mb-3 text-left ">

                        <form class="d-flex flex-column align-items-center col-12" action="" method="post">

                            <p class="mt-5 mb-0 text-left col-11 p-0">Si has olvidado tu contraseña, introduce tu dirección de e-mail y te enviaremos un mensaje
                                por correo con una contraseña nueva.
                            </p>

                            <label class="labEscritorio col-12 " for="email">Email</label>
                            <input type="email" class="mb-2 col-11" name="email" id="email" placeholder="email" required>
